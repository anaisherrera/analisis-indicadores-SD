...
El presente documento expone un análisis de las escalas presentadas en el cuestionario de Saberes Docentes. El documento esta estructurado según escalas, presentándose cada escala como una sección seleccionable en la barra de la izquierda. Dentro de cada sección se muestra un gráfico descriptivo de los indicadores de la escala, un gráfico con las correlaciones entre los indicadores y un análisis de validez basado en los resultados de Análisis Factoriales Confirmatorios. 
...
Cuestionario_SD_09_09 = Cuestionario_SD_09_09 %>%  filter(Q1==1) %>% as.data.frame()
Cuestionario_SD_09_09 <- Cuestionario_SD_09_09 %>% filter(!is.na(Cuestionario_SD_09_09$Q9 | Cuestionario_SD_09_09$Q28))
